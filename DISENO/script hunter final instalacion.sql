...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-12-2018 a las 20:33:34
...
CREATE TABLE `cafes` (
  ...
  `pesoMuestra` int(11) NOT NULL,
  `pesoRecibido` int(11) NOT NULL,
  `especie` varchar(45) NOT NULL,
  `variedad` varchar(45) NOT NULL,
  `porcentajeHumedad` int(11) NOT NULL,
  `factorRendimiento` int(11) NOT NULL,
  `tipoTueste` varchar(200) NOT NULL,
  `actividadAcuosa` int(11) NOT NULL,
  `molidaLibra` int(11) NOT NULL,
  `molidaMediaLibra` int(11) NOT NULL,
  `molidaCincoLibras` int(11) DEFAULT NULL,
  `granoLibra` int(11) NOT NULL,
  `granoMediaLibra` int(11) NOT NULL,
  `granoCincoLibras` int(11) DEFAULT NULL,
  `agranel` int(11) NOT NULL,
  `VrmolidaLibra` decimal(10,0) DEFAULT NULL,
  `VrmolidaCincoLibras` decimal(10,0) DEFAULT NULL,
  `VrmolidaMediaLibra` decimal(10,0) DEFAULT NULL,
  `VrgranoLibra` decimal(10,0) DEFAULT NULL,
  `VrgranoMediaLibra` decimal(10,0) DEFAULT NULL,
  `VrgranoCincoLibras` decimal(10,0) DEFAULT NULL,
  `VrAgranel` decimal(10,0) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `datosempaque`
--

CREATE TABLE `datosempaque` (
  `iddatosEmpaque` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `datosestabilización`
--

CREATE TABLE `datosestabilización` (
  `iddatosEstabilizacion` int(11) NOT NULL,
  `fechaHora` datetime NOT NULL,
  `idcafe` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `datoslaboratorio`
--

CREATE TABLE `datoslaboratorio` (
  `iddatosLaboratorio` int(11) NOT NULL,
  `fechaHora` datetime NOT NULL,
  `idcafe` int(11) NOT NULL,
  `perfildeTaza2` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `datospruebasdelaboratorio`
--

CREATE TABLE `datospruebasdelaboratorio` (
  `iddatosPruebasLaboratorio` int(11) NOT NULL,
  `fechaHora` datetime NOT NULL,
  `idcafe` int(11) NOT NULL,
  `humedad` int(11) NOT NULL,
  `densidad` int(11) NOT NULL,
  `actividadAcuosa` int(11) NOT NULL,
  `diseñoCurva` int(11) NOT NULL,
  `observación` text NOT NULL,
  `created_at` date DEFAULT NULL,
  `update_at` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `datostorrefactor`
--

CREATE TABLE `datostorrefactor` (
  `iddatosTorrefactor` int(11) NOT NULL,
  `fechaHora` datetime NOT NULL,
  `idcafe` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `datostrilla`
--

CREATE TABLE `datostrilla` (
  `idDatoTrilla` int(11) NOT NULL,
  `fechaHora` datetime NOT NULL,
  `idcafe` int(11) NOT NULL,
...
CREATE TABLE `detallefinca` (
  ...
  `coordenadasGoogle` varchar(45) NOT NULL,
...
CREATE TABLE `estadostorrefaccion` (
  `idestadosTorrefaccion` int(11) NOT NULL,
  `idcafe` int(11) NOT NULL,
  `fechaHora` datetime NOT NULL,
  `codigoEstado` varchar(45) NOT NULL,
  `observfacion` text NOT NULL,
...
INSERT INTO `materiaprima` (`idmateriaPrima`, `nombre`, `estado`) VALUES
(1, 'Trillado', 'Activo'),
(2, 'Pergamino', 'Activo');
...
INSERT INTO `personas` (`idPersona`, `primerNombre`, `segundoNombre`, `primerApellido`, `segundoApellido`, `documentoIdentidad`, `fechaNacimiento`, `sexo`, `correo`, `numeroContacto`, `direccion`, `tipoPersona`, `rol`, `contrasena`, `estado`, `created_at`, `updated_at`, `created_by`, `updated_by`, `foto`) VALUES
(1, 'admin', NULL, '', NULL, '123', '0000-00-00', '', '', '', '', '', 'administrador', '123', 'Activo', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `recepciones` (
  ...
  `cantidadImpresionesFactura` int(11) NOT NULL,
  `fechaImpresionFactura` date NOT NULL,
  `cantidadImpresionesRecibo` int(11) NOT NULL,
...
ALTER TABLE `cafes`
  ...
  ADD KEY `materi_cafe_idx` (`idmateriaPrima`),
  ADD KEY `cafe_recepcion_idx` (`idRecepcion`),
  ADD KEY `beneficio_Cafe_idx` (`idtipoBeneficio`);

--
-- Indices de la tabla `datosempaque`
--
ALTER TABLE `datosempaque`
  ADD PRIMARY KEY (`iddatosEmpaque`),
  ADD KEY `datosempaque_cafes_idx` (`idcafe`);

--
-- Indices de la tabla `datosestabilización`
--
ALTER TABLE `datosestabilización`
  ADD PRIMARY KEY (`iddatosEstabilizacion`),
  ADD KEY `datosestabilizacion_cafe_idx` (`idcafe`);

--
-- Indices de la tabla `datoslaboratorio`
--
ALTER TABLE `datoslaboratorio`
  ADD PRIMARY KEY (`iddatosLaboratorio`),
  ADD KEY `datoslab_cafe_idx` (`idcafe`);

--
-- Indices de la tabla `datospruebasdelaboratorio`
--
ALTER TABLE `datospruebasdelaboratorio`
  ADD PRIMARY KEY (`iddatosPruebasLaboratorio`),
  ADD KEY `datospruebas_cafes_idx` (`idcafe`);

--
-- Indices de la tabla `datostorrefactor`
--
ALTER TABLE `datostorrefactor`
  ADD PRIMARY KEY (`iddatosTorrefactor`),
  ADD KEY `datostorrefactor_cafes_idx` (`idcafe`);

--
-- Indices de la tabla `datostrilla`
--
ALTER TABLE `datostrilla`
  ADD PRIMARY KEY (`idDatoTrilla`),
  ADD KEY `DATOSTRILLA_CAFES_idx` (`idcafe`);
...
ALTER TABLE `detallefinca`
  ...
  ADD KEY `cliente_fincas_idx` (`idCliente`),
  ADD KEY `finca_muni_idx` (`idmunicipio`);

--
-- Indices de la tabla `estadostorrefaccion`
--
ALTER TABLE `estadostorrefaccion`
  ADD PRIMARY KEY (`idestadosTorrefaccion`),
  ADD KEY `datostorrefaccion_cafe_idx` (`idcafe`);
...
ALTER TABLE `recepciones`
  ...
  ADD KEY `recepciones_clientes_idx` (`idcliente`),
  ADD KEY `fincas_recepciones_idx` (`idFinca`);
...
--
-- AUTO_INCREMENT de la tabla `datosempaque`
--
ALTER TABLE `datosempaque`
  MODIFY `iddatosEmpaque` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `datosestabilización`
--
ALTER TABLE `datosestabilización`
  MODIFY `iddatosEstabilizacion` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `datospruebasdelaboratorio`
--
ALTER TABLE `datospruebasdelaboratorio`
  MODIFY `iddatosPruebasLaboratorio` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `datostorrefactor`
--
ALTER TABLE `datostorrefactor`
  MODIFY `iddatosTorrefactor` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `datostrilla`
--
ALTER TABLE `datostrilla`
  MODIFY `idDatoTrilla` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `detallefinca`
--
ALTER TABLE `detallefinca`
  MODIFY `idDetalleFinca` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `estadostorrefaccion`
--
ALTER TABLE `estadostorrefaccion`
  MODIFY `idestadosTorrefaccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `recepciones`
  MODIFY `numeroRecibo` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `cafes`
  ADD CONSTRAINT `beneficio_Cafe` FOREIGN KEY (`idtipoBeneficio`) REFERENCES `tipobeneficio` (`idtipoBeneficio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `cafe_recepcion` FOREIGN KEY (`idRecepcion`) REFERENCES `recepciones` (`numeroRecibo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `materi_cafe` FOREIGN KEY (`idmateriaPrima`) REFERENCES `materiaprima` (`idmateriaPrima`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `datosempaque`
--
ALTER TABLE `datosempaque`
  ADD CONSTRAINT `datosempaque_cafes` FOREIGN KEY (`idcafe`) REFERENCES `cafes` (`idcafe`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `datosestabilización`
--
ALTER TABLE `datosestabilización`
  ADD CONSTRAINT `datosestabilizacion_cafe` FOREIGN KEY (`idcafe`) REFERENCES `cafes` (`idcafe`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `datoslaboratorio`
--
ALTER TABLE `datoslaboratorio`
  ADD CONSTRAINT `datoslab_cafe` FOREIGN KEY (`idcafe`) REFERENCES `cafes` (`idcafe`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `datospruebasdelaboratorio`
--
ALTER TABLE `datospruebasdelaboratorio`
  ADD CONSTRAINT `datospruebas_cafes` FOREIGN KEY (`idcafe`) REFERENCES `cafes` (`idcafe`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `datostorrefactor`
--
ALTER TABLE `datostorrefactor`
  ADD CONSTRAINT `datostorrefactor_cafes` FOREIGN KEY (`idcafe`) REFERENCES `cafes` (`idcafe`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `datostrilla`
--
ALTER TABLE `datostrilla`
  ADD CONSTRAINT `DATOSTRILLA_CAFES` FOREIGN KEY (`idcafe`) REFERENCES `cafes` (`idcafe`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detallefinca`
--
ALTER TABLE `detallefinca`
  ADD CONSTRAINT `cliente_fincas` FOREIGN KEY (`idCliente`) REFERENCES `personas` (`idPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `finca_muni` FOREIGN KEY (`idmunicipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `estadostorrefaccion`
--
ALTER TABLE `estadostorrefaccion`
  ADD CONSTRAINT `datostorrefaccion_cafe` FOREIGN KEY (`idcafe`) REFERENCES `cafes` (`idcafe`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `municipios`
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `depa_muni` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id_departamento`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `recepciones`
--
ALTER TABLE `recepciones`
  ADD CONSTRAINT `fincas_recepciones` FOREIGN KEY (`idFinca`) REFERENCES `detallefinca` (`idDetalleFinca`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `recepciones_clientes` FOREIGN KEY (`idcliente`) REFERENCES `personas` (`idPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
